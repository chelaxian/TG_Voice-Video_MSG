...
messages = {
    ...
    "stop": {
        "RU": "Бот остановлен. Файлы удалены.\n\n`/START_voice-video_bot` - запустить бота снова",
        "EN": "Bot stopped. Files deleted.\n\n`/START_voice-video_bot` - start the bot again",
        "CN": "机器人已停止。文件已删除。\n\n`/START_voice-video_bot` - 重新启动机器 人"
    },
    "send_file": {
